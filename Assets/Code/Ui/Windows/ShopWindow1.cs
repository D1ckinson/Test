...
namespace Assets.Code.Ui.Windows
{
    public class ShopWindow1 : BaseWindow
    {
        ...
        private readonly Dictionary<AbilityType, ShopOption1> _options = new();
        ...
        {
            foreach (ShopOption1 shopOption in _options.Values)
            {
        ...
        public ShopWindow1 Initialize(Dictionary<AbilityType, int> abilityUnlockLevel, Dictionary<AbilityType, int> abilityMaxLevel, UpgradeCost upgradeCost, Wallet wallet)
        {
        ...
        public void AddOption(ShopOption1 option)
        {
        ...
        private void UpdateOption(ShopOption1 option, float coinsQuantity)
        {
            AbilityType abilityType = option.AbilityType;
